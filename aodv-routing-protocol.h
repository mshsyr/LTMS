...
bool PromiscReceive (Ptr<NetDevice> device, Ptr<const Packet> packet, uint16_t protocol, const Address &from,
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	///////////////////////////////////////////////////////////////////////////
	//Callback<double, double> test;
	//void SetTestCallback (Callback<double, double>);
	//Ptr<Trust> GetTestCallback();
	//////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////////////////MSH
  void SetMalicious(int att) {
	...
	bool IsNeighbor(Ipv4Address x)  {  // This function to check if the node is in the direct communication range or not
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////MSH
  uint16_t maliciousAttribute; // 1- Developing good scenario, 2- Developing bad scenario, 3- Change from good to bad scenario, 4- Fixed On off attack, 5- Percentage On Off attack
  uint16_t onOffAttackAttribute;
  Ipv4Address forwardedAttribute;
  bool promiscAttribute;
  uint16_t optionAttribute; 
  double onOffPercentAttribute; 
  uint16_t initPeriodAttribute;  // To set the initialization period where the node is behaving good
